...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | 重楼")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'OJ5BZ-74Q6X-V4L43-ZNRZ7-XH5RH-JFFLR',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 重楼") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('重楼的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if (m == 3 && dd == 9) {//站长生日
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("祝站长" + (y - 1996).toString() + "岁生日快乐！");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
if (m == 6 && dd == 28) {//老婆生日
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("祝老婆" + (y - 1996).toString() + "岁生日快乐！");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.shields.io/badge/魔尊の小屋-在线摸鱼中-9cf.svg?style=social&logo=buymeacoffee' title='好想一夜暴富呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/魔尊の小屋-下班休息啦-9cf.svg?style=social&logo=buymeacoffee' title='下班咯，哎嘿嘿~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/111.png)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/111.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/114.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/114.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/112.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/112.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/119.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/119.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/11e.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/11e.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/112.png)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/112.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/127.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/127.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/113.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/113.jpg)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/143.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/143.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/142.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/142.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/145.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/145.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/146.jpg)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/fj1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/147.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/147.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/141.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/141.jpg)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/162.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/162.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/163.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/163.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/166.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/166.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/168.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/168.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/167.jpg)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/167.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/161.png)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/161.png)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/116.jpg)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/116.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/115.jpg)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/115.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/131.jpg)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/131.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/44.jpg)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/44.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/03/04/55.png)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/03/04/55.png)')"></a></div>
              </div>
            </details>
